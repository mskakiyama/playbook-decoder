...
function AuthFormContainer({ isSignIn, onToggle, onSignIn, onSignUp, onSkip, loading }: AuthFormContainerProps) {
    return (
        <div className="mx-auto grid w-[350px] gap-2">
            {isSignIn ? <SignInForm onSubmit={onSignIn} loading={loading} /> : <SignUpForm onSubmit={onSignUp} loading={loading} />}
            ...
            {onSkip && (
              <Button variant="outline" type="button" onClick={onSkip} className="mt-2">
...
export function AuthUI({ signInContent = {}, signUpContent = {}, onSignIn, onSignUp, onSkip, loading = false }: AuthUIProps) {
  ...
  return (
    <div className="w-full min-h-screen md:grid md:grid-cols-2">
      ...
      <div className="flex h-screen items-center justify-center p-6 md:h-auto md:p-0 md:py-12">
        <AuthFormContainer isSignIn={isSignIn} onToggle={toggleForm} onSignIn={onSignIn} onSignUp={onSignUp} onSkip={onSkip} loading={loading} />
      </div>
